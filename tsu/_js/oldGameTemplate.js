...
addEventListener("keyup", funtion(e) {
...
let player = new Player(25, 25, canvas.width / 2, canvas.height / 2)

// create instance of class Csquare
let anotherSquare = new fSquare(40, 40, 25, 25);
